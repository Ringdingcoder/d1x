...
Victor Rachels is supporting the code base currently through his website at
http://d1x.warpcore.org.  If you have questions or comments
about the code, please go there.  Please do not contact Parallax Software,
its employees or its affiliates.

Any executable created using files or code taken from this source tree MUST
be open source.  By using this source, you are agreeing to this term, in
the interest of the descent and descent programming communities.  The only
exception is if the writer of the original source gives explicit permission
for the code to be used otherwise.
